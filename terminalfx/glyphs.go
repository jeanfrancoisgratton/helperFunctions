...
// Stop signs
func EuropeanStopSign(sentence string) string { return fmt.Sprintf("⛔️ %s%s", reset, sentence) }
...
func SkullBonesSign(sentence string) string { return fmt.Sprintf("☠️ %s%s", reset, sentence) }

// Accepted/denied
func EnabledSign(sentence string) string { return fmt.Sprintf("✅️ %s%s", reset, sentence) }
func ErrorSign(sentence string) string   { return fmt.Sprintf("❌️ %s%s", reset, sentence) }
