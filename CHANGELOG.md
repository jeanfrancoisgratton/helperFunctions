...
| 4.1.0   | 2025.12.31    | Added a prettyjson subpackage, to prettify JSON output, "à-la-jq"                                              |
...
| 4.0.0   | _(continued)_ | Glyph function calls are cleaner<br>All log init options are now wrapped in a single struct                    |                             
